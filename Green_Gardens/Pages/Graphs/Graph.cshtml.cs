...
namespace Green_Gardens.Pages.Graphs
{
    public class GraphModel : PageModel
    {
        ...
        //Gets the information from the database tables
        ...
        public void OnGet()
        {
            //specific values from the tables
			...
			OrderJson = JsonSerializer.Serialize(order.Select(o => new { o.Quantity, o.Product.Name}));
